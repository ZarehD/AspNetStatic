...
public class LinkHelperTests
{
    ...
    [DataRow(@"<a class=""abcd"" href=""/docs/page1"" title=""test"">", @"<a class=""abcd"" href=""/docs/page1.html"" title=""test"">")]
    [DataRow(@"<a class=""abcd"" href=""/docs/page2"" title=""test"">", @"<a class=""abcd"" href=""/docs/page2/index.html"" title=""test"">")]
    [DataRow(@"<a class=&quot;abcd&quot; href=""/docs"" title=""test"">", @"<a class=&quot;abcd&quot; href=""/docs/index.html"" title=""test"">")]
    [DataRow(@"<a class=""&+-_;"" href=""/docs"" title=""test"">", @"<a class=""&+-_;"" href=""/docs/index.html"" title=""test"">")]
    [DataRow(@"<a href="""" title=""test"">", @"<a href="""" title=""test"">")]
	[DataRow(@"<a href=""/"" title=""test"">", @"<a href=""/index.html"" title=""test"">")]
    [DataRow(@"<a class=""abcd"" href=""/#features"" title=""test"">", @"<a class=""abcd"" href=""/index.html#features"" title=""test"">")]
    [DataRow(
