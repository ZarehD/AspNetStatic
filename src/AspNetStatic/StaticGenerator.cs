...
namespace AspNetStatic
{
	internal class StaticGenerator
	{
		...
		{
			public IEnumerable<PageResource> AllPages { get; }
			...
			public ILogger<StaticGenerator>? Logger { get; }


			public PageResourceProcessorConfig(
		...
		private class OtherResourceProcessorConfig
		{
			...
			public OtherResourceProcessorConfig(
				bool optimizeOutput,
				IOptimizerSelector? optimizerSelector,
				string destinationRoot,
				HttpClient httpClient,
