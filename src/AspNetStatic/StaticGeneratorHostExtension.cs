...
namespace AspNetStatic
{
    public static class StaticGeneratorHostExtension
    {
            ...
            bool ignoreSslErrors = default)
        {
            ...
            InitializeHttpClient(ignoreSslErrors);
        ...
        private static void InitializeHttpClient(bool ignoreSslErrors)
        {
            if (!ignoreSslErrors)
            {
                _httpClient = new();
            ...
            _httpClient = new(new HttpClientHandler
            {
                ...
                ServerCertificateCustomValidationCallback =
                    (reqst, cert, chain, errs) => { return true; }
            });
        }

        private static readonly CancellationTokenSource _appShutdown = new();
        private static /*readonly*/ HttpClient _httpClient = null!;// new();
#if USE_PERIODIC_TIMER
