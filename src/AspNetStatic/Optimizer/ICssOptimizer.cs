...
public interface ICssOptimizer
{
	CssOptimizerResult Execute(string content, CssResource resource, string outFilePathname);
}


public class CssOptimizerResult : OptimizerResult<string>
{
